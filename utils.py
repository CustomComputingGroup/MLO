...
def get_run_type_visualizer(trial_name):
    from views.visualizers.plot import MLORunReportViewer,regressionMLORunViewer
    return {"PSOTrial" : {"MLOReportViewer" : MLORunReportViewer,"regressions": regressionMLORunViewer, "default" : MLORunReportViewer}, 
            "PSOTrial_TimeAware" : {"MLOReportViewer" : MLORunReportViewer,"regressions": regressionMLORunViewer, "default" : MLORunReportViewer}, 
            "Blank" : {"Blank" : None, "default" : None}}[trial_name] 
